      ...
      <div className="pb-5 border-b border-gray-700/40">
        <div className="flex justify-between items-center">
          ...
          <div className="relative py-2 group">
            ...
            />
            <div className="absolute top-full right-0 z-20 w-36 p-3 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block shadow-lg">
              <p
        ...
        {filteredUsers.map((user, index) => (
          ...
          >
            <img
              ...
              alt={user.fullName}
              className="w-[38px] h-[38px] rounded-full object-cover border border-gray-600"
            />
            ...
            {unseenMessages[user._id] > 0 && (
              <p className="absolute top-3 right-4 text-xs h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/70 text-white font-medium">
